...
const serviceAccount = require("./motiveko-84a06-firebase-adminsdk-45e93-87f1e6d84d.json")
...
exports.storePushData = functions.https.onRequest((request, response) => {
  ...
  cors(request, response, () => {
    ...
    webpush.setVapidDetails('mailto:abc@abc.com','BDd2EsaQxJSwePTOwuzZhqXv3eBrKB1cZFJnVr07Q7z4YzKQWzqcKEIGqUt3UH7IVHrubmqtFwD1kZ-JGHg6G98', 'tJqoP_lXWGkbrRU37-PBbGsyH_dZyTn5dI8MZvNWzK8');
