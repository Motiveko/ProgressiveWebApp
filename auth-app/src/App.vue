  ...
  <v-app>
    ...
    <v-app-bar app clipped-left color="primary" dark>
      ...
      <router-link to="/" style="cursor: pointer">
        ...
        <!-- 홈로고 아이콘은 반응형 크기가 md이하일때 숨김 -->
        <v-icon class="hidden-md-and-down" large color="teal 
...
export default {
  ...
  methods: {
    fnDoLogout() {
      // $를 사용해 뷰 객체를 생성할 때 선언한 속성들에 접근 할 수 있다.
